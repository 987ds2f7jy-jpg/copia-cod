...
- Name: professional\professional-dashboard.spec.ts >> professional-dashboard — profissional aprovado >> sessão persiste após reload @critical
- Location: tests\e2e\professional\professional-dashboard.spec.ts:153:3
