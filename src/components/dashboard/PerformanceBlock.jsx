...
export default function PerformanceBlock({ appointments, questions, professional }) {
  ...
  const items = [
    { label: 'Horário mais produtivo', value: busiestHour, icon: Clock, color: 'text-indigo-500 bg-indigo-50' },
    { label: 'Especialidade principal', value: specialty, icon: BarChart2, color: 'text-purple-500 bg-purple-50' },
    { label: 'Taxa de retorno', value: `${returnRate}%`, icon: RefreshCw, color: 'text-emerald-600 bg-emerald-50' },
    { label: 'Taxa de resposta (perguntas)', value: `${answerRate}%`, icon: MessageSquare, color: 'text-blue-500 bg-blue-50' },
  ];
