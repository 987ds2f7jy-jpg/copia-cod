...
- Name: patient\planos.spec.ts >> planos - checkout autenticado >> envia somente plan_code ao backend e redireciona para checkout
- Location: tests\e2e\patient\planos.spec.ts:76:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/Planos
Call log:
  - navigating to "http://localhost:8080/Planos", waiting until "load"
