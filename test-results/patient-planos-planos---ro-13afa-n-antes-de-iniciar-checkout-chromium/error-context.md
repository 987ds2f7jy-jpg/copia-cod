...
- Name: patient\planos.spec.ts >> planos - rota publica e planos individuais >> CTA de plano exige login antes de iniciar checkout
- Location: tests\e2e\patient\planos.spec.ts:65:3
