...
- Name: professional\edit-and-deactivate.spec.ts >> perfil — AlertDialog de desativação >> "Cancelar" no AlertDialog fecha sem desativar @critical
- Location: tests\e2e\professional\edit-and-deactivate.spec.ts:204:3
