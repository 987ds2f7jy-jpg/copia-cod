...
- Name: professional\professional-dashboard.spec.ts >> professional-dashboard — profissional aprovado >> após logout, dashboard redireciona para /Entrar
- Location: tests\e2e\professional\professional-dashboard.spec.ts:163:3
