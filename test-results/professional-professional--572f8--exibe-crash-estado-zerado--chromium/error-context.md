...
- Name: professional\professional-dashboard.spec.ts >> professional-dashboard — profissional aprovado >> dashboard sem consultas não exibe crash (estado zerado)
- Location: tests\e2e\professional\professional-dashboard.spec.ts:176:3
