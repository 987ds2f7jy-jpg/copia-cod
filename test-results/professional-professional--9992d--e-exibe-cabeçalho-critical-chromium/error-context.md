...
- Name: professional\professional-dashboard.spec.ts >> professional-dashboard — profissional aprovado >> carrega com sessão válida e exibe cabeçalho @critical
- Location: tests\e2e\professional\professional-dashboard.spec.ts:61:3
